...
public class GPScoordinatesTest {
	...
	public void testGPScoordinatesStringString_basic_positive_positive() {
		...
		try {
			...
			assertTrue("Test du constructeur avec les String positifs et positifs", gps1 instanceof GPScoordinates && gps1.getLatitude()==10 && gps1.getLongitude()==15);
			gps2 = new GPScoordinates("10�0'0,0\"","-15�0'0,0\"");
			assertTrue("Test du constructeur avec les String positifs et positifs", gps2 instanceof GPScoordinates && gps2.getLatitude()==10 && gps2.getLongitude()==-15);
			gps3 = new GPScoordinates("-10�0'0,0\"","15�0'0,0\"");
			assertTrue("Test du constructeur avec les String positifs et positifs", gps3 instanceof GPScoordinates && gps3.getLatitude()==-10 && gps3.getLongitude()==15);
			gps4 = new GPScoordinates("-10�0'0,0\"","-15�0'0,0\"");
			assertTrue("Test du constructeur avec les String positifs et positifs", gps4 instanceof GPScoordinates && gps4.getLatitude()==-10 && gps4.getLongitude()==-15 );
