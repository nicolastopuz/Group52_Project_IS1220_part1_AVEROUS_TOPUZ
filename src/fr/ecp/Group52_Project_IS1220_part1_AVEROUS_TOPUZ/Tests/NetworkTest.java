...
public class NetworkTest {
	...
	public void testNetworkIntIntDouble() {
		try {
			...
			Network n2 = new Network(1,10,0.7);
			...
			Network n5 = new Network(5,2,0.5);
