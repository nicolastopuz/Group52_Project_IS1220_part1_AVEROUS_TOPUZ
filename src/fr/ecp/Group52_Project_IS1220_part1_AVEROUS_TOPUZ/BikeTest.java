...
public class BikeTest {
	...
	public void testHashCode() {
		...
		assertTrue("Test du hashCode pour 2 vélos du même type", b1.hashCode()!=b2.hashCode());
		assertTrue("Test du hashCode pour 2 vélos de types différents", b1.hashCode()!=b3.hashCode());
		assertTrue("Test du hashCode pour un seul et même objet", b1.hashCode()==b1.hashCode());
	}
	...
	public void testBike() {
		...
		Bike b1 = BikeFactory.create(BikesType.Electrical);
		assertTrue("Test du constructeur de Bike", b+1==Bike.bikeCounter && b1.getNumericalId()==b+1);
	}

	@Test
	public void testGetBikeCounter() {
		double b = Bike.bikeCounter;
		Bike b1 = BikeFactory.create(BikesType.Electrical);
	...
	public void testEqualsObject() {
		...
		assertTrue("Test de equals sur 2 velos de types différents", !b1.equals(b3));
